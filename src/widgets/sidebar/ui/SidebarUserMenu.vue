  ...
  <Teleport to="body">
    ...
    >
      ...
      <div class="border-t border-zinc-200 p-3">
        <button
          type="button"
          class="flex w-full items-center justify-center rounded-lg border border-red-200 px-3 py-2 text-sm text-red-700 transition-colors hover:bg-red-50 focus:outline-none"
          @click="$emit('logout')"
        >
          Вийти
        </button>
