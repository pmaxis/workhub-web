    ...
    },
    {
      ...
      children: [
        ...
        },
        {
          ...
          component: () => import('@/pages/KnowledgeArticleFormPage.vue'),
        ...
        },
        {
          path: 'templates/new',
          name: 'templateCreate',
          component: () => import('@/pages/TemplateFormPage.vue'),
        ...
        },
        {
          path: 'journal/new',
          name: 'journalCreate',
          component: () => import('@/pages/JournalFormPage.vue'),
          meta: { pageTitle: 'New journal entry' },
        },
        {
          path: 'journal/:id/edit',
          name: 'journalEdit',
          component: () => import('@/pages/JournalFormPage.vue'),
          meta: { pageTitle: 'Edit journal entry' },
        },
      ],
    },
    {
