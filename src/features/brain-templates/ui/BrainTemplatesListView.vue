<template>
  <div class="flex flex-col gap-4">
    <div class="flex flex-wrap items-start justify-between gap-4">
      <div>
        <h1 class="text-2xl font-semibold text-zinc-900">Templates</h1>
        <p class="mt-1 text-sm text-zinc-600">Reusable text blocks — emails, briefs, placeholders.</p>
      </div>
      <router-link
    ...
    <ConfirmDeleteModal v-model="deleteTarget" @confirm="confirmDelete">
      <template #message>template “{{ deleteTarget?.title }}”</template>
    </ConfirmDeleteModal>
...
import { useBrainTemplatesList } from '@/features/brain-templates/model/useBrainTemplatesList';
import BrainTemplatesTable from '@/features/brain-templates/ui/BrainTemplatesTable.vue';
