  ...
  <div class="space-y-6">
    ...
    <div class="rounded-xl border border-zinc-200 bg-zinc-50 p-6">
      ...
      <Form class="mt-5 space-y-4" @submit.prevent="submit">
        ...
        <FormField v-model="title" label="Title" id="ka-title" type="text" required />
        <FormField
          v-model="body"
          label="Content"
          id="ka-body"
          as="textarea"
          rows="12"
          placeholder="Structured reference content…"
        />
        <FormField v-model="tags" label="Tags" id="ka-tags" type="text" placeholder="comma-separated" />
        <FormField
          v-model="taskId"
          label="Task"
          id="ka-task"
...
import { useKnowledgeArticleForm } from '@/features/knowledge-articles/model/useKnowledgeArticleForm';
